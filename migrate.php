...
$truncate_migrate_play_tables_query = "TRUNCATE migrate_play_timed_pattern_stops_nonnormalized, migrate_play_agency, migrate_play_pattern_stop, migrate_play_timed_pattern_stop, migrate_play_timed_pattern, migrate_play_routes, migrate_play_pattern, migrate_play_headsigns, migrate_play_directions RESTART IDENTITY;";
$truncate_migrate_play_tables_result = db_query($truncate_migrate_play_tables_query);

$migrate_play_timed_pattern_stops_nonnormalized_query  = "insert into migrate_play_timed_pattern_stops_nonnormalized (agency_id, agency_name, route_short_name, route_long_name, direction_label, direction_id, trip_headsign_id, trip_headsign, stop_id, stop_order, timed_pattern_id, pattern_id, arrival_time, departure_time, pickup_type, drop_off_type, one_trip, trips_list, stops_pattern, arrival_time_intervals, departure_time_intervals, route_id, stop_headsign_id)
...
$migrate_play_timed_pattern_stops_nonnormalized_result = db_query($migrate_play_timed_pattern_stops_nonnormalized_query);

$migrate_play_agency_query  = "insert into migrate_play_agency (agency_id, agency_id_import, agency_url, agency_timezone, agency_lang_id, agency_name, agency_short_name, agency_phone, agency_fare_url, agency_info, query_tracking, last_modified, maintenance_start, gtfs_plus, no_frequencies) select agency_id, agency_id_import, agency_url, agency_timezone, agency_lang_id, agency_name, agency_short_name, agency_phone, agency_fare_url, agency_info, query_tracking, last_modified, maintenance_start, gtfs_plus, no_frequencies from agency where agency_id IN ($agency_string)";
$migrate_play_agency_result = db_query($migrate_play_agency_query);

// pattern_stop.sql
$migrate_play_pattern_stop_query  = "INSERT into migrate_play_pattern_stop
SELECT DISTINCT  agency_id, pattern_id, stop_order, stop_id 
FROM migrate_play_timed_pattern_stops_nonnormalized
ORDER BY agency_id, pattern_id, stop_order";
$result = db_query($migrate_play_pattern_stop_query);

// timed_pattern_intervals.sql
$migrate_play_timed_pattern_stop_query  = "INSERT into migrate_play_timed_pattern_stop (agency_id, timed_pattern_id, stop_order, arrival_time, departure_time, pickup_type, drop_off_type, headsign_id)
...
$result = db_query($migrate_play_timed_pattern_stop_query);

// timed_pattern.sql
$migrate_play_timed_pattern_query  = "INSERT into migrate_play_timed_pattern (agency_id, timed_pattern_id, pattern_id)
SELECT DISTINCT agency_id, timed_pattern_id, pattern_id
FROM migrate_play_timed_pattern_stops_nonnormalized
ORDER BY agency_id, pattern_id, timed_pattern_id";
$result = db_query($migrate_play_timed_pattern_query);

// routes.sql
$migrate_play_routes_stop_query  = "insert into migrate_play_routes (agency_id, route_id, route_short_name, route_long_name, route_desc, route_type, route_color, route_text_color, route_url, route_bikes_allowed, route_id_import, last_modified, route_sort_order, hidden) select agency_id, route_id, route_short_name, route_long_name, route_desc, route_type, route_color, route_text_color, route_url, route_bikes_allowed, route_id_import, last_modified, route_sort_order, hidden from routes where agency_id IN ($agency_string)";
$result = db_query($migrate_play_routes_stop_query);

// patterns.sql
// solution for now is DISTINCT ON <-- come back here and look at taking out the DISTINCT ON
$migrate_play_pattern_query  = "INSERT into migrate_play_pattern (agency_id, pattern_id, route_id, direction_id)
...
$result = db_query($migrate_play_pattern_query);
...
$migrate_play_headsigns_query  = "INSERT into migrate_play_headsigns (agency_id, headsign_id, headsign)
SELECT DISTINCT  agency_id, trip_headsign_id as headsign_id, trip_headsign AS headsign
FROM migrate_play_timed_pattern_stops_nonnormalized where trip_headsign_id IS NOT NULL AND trip_headsign IS NOT NULL
UNION
SELECT DISTINCT  agency_id, stop_headsign_id as headsign_id, stop_headsign AS headsign
FROM migrate_play_timed_pattern_stops_nonnormalized where stop_headsign_id IS NOT NULL AND stop_headsign IS NOT NULL
ORDER BY agency_id, headsign_id";
$result = db_query($migrate_play_headsigns_query);

// directions.sql
// ALERT!! There are some duplicate direction_id values to look ingo
$migrate_play_directions_query  = "INSERT into migrate_play_directions (agency_id, direction_id, direction_label)
SELECT DISTINCT on (direction_id)  agency_id, direction_id, direction_label
FROM migrate_play_timed_pattern_stops_nonnormalized
ORDER BY direction_id, agency_id";
$result = db_query($migrate_play_directions_query);
