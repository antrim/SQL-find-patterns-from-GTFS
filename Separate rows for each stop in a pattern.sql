...
one_trip,trips_list,timed_patterns.stops_pattern,stop_time_intervals,route_id,route_short_name,route_long_name,direction_label,headsign FROM timed_patterns
LEFT JOIN stop_times ON timed_patterns.one_trip = stop_times.trip_id
LEFT JOIN stop_patterns ON timed_patterns.stops_pattern = stop_patterns.stops_pattern
