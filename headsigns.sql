...
SELECT timed_patterns.agency_id,agency.agency_name,routes.route_short_name,routes.route_long_name,directions.direction_id,directions.direction_label,headsigns.headsign_id,headsigns.headsign,stop_times.stop_id,
...
SELECT DISTINCT  agency_id, headsign_id, headsign
FROM result_set
